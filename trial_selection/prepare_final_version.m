...
if server == 1
    ...
    resultfolder = [basefolder, 'rds/rds-tb419-bekinschtein/Joaquim/DATA (see Yanzhis folder)/READY/PAPER_LAST_VERSION/CF/']; % the READY folder is where I save all prepared data
...
if strcmp(state, 'S')
    ...
    behav_data = assess_drowsy(subject, behav_data, rej_trials); % also need to reject some trials for 6 participants: 117, 126, 127, 140, 141, 144
end
