function prepare_across_final_version(params, state, task_id)
...
if server == 1
    ...
    resultfolder = [basefolder, 'rds/rds-tb419-bekinschtein/Joaquim/DATA (see Yanzhis folder)/READY/across_final/'];
...
count_event = modify_events_across(task_id, eeg_file, behav_data, subject, state, finalfolder);
