...
cfg = []; 
cfg.startdir = 'C:\Metacognition_Project\REPLICATION_INDICES_CATE'; 
...
cfg.timelim = [-200 1200]; % to change awake-drowsy to have the same length
mvpa_pd_drowsy = adam_compute_group_MVPA(cfg);
...
cfg.acclim = [.45 .80];      
cfg.channelpool = 'ALL';      
adam_plot_MVPA(cfg, mvpa_cf_drowsy);    
...
cfg = [];                       
cfg.startdir = 'C:\Metacognition_Project\REPLICATION_INDICES_CATE2'; 
cfg.mpcompcor_method = 'cluster_based'; 
% cfg.mpcompcor_method = 'FDR';
cfg.iterations = 1000;        
% cfg.channelpool = 'ALL_NO_SELECTION';   
