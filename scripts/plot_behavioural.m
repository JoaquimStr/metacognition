...
folder = 'C:/Metacognition_project/FINAL CLEAN BEHAV'; % for continuum (20) data
...
for n = 1:23 % add more subjects
    ...
    d(n, 1) = behav_data_W.meta_d.d1;
    d(n, 2) = behav_data_S.meta_d.d1;
    meta(n, 1) = behav_data_W.meta_d.meta_d;
    meta(n, 2) = behav_data_S.meta_d.meta_d;
    ratio(n, 1) = behav_data_W.meta_d.M_ratio;
    ratio(n, 2) = behav_data_S.meta_d.M_ratio;
end
